...
$(document).ready(function () {
    ...
    //Checks if drodown menu's li elements have anothere level (ul), if not the dropdown is shown as regular dropdown, not a  menu (thanks Luka Kladaric)

    //$(".mega-menu > ul").before("<a href=\"#\" class=\"menu-mobile\">Silverstripe</a>");
